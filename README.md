...
- Real-time price tracking for major tokens (BTC, ETH, BlockDAG, and more)
- One-tap token swaps with live exchange rates
- Portfolio dashboard with 24h performance metrics
- Transaction history with detailed breakdowns
- Dark mode / Light mode for comfortable viewing
...
**Frontend**  
React, Tailwind CSS, Lovable – Fast, responsive, and beautiful

**Blockchain**  
Solidity smart contracts deployed on BlockDAG with multi-chain support

**Backend**  
Node.js and Express for API management and data processing

**AI Integration**  
Machine learning models for price prediction and trading analysis

**Data Layer**  
MongoDB for user preferences, CoinGecko API for live market data
...
Built for the BlockDAG Buildathon 2025.
